...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Visual", "f56c2c", "dae8f3", "NONE")

    " Interface Elements
    call <SID>X("StatusLine", "ffffff", "43c464", "bold")
    call <SID>X("StatusLineNC", "9bd4a9", "51b069", "NONE")
    call <SID>X("VertSplit", "3687a2", "3687a2", "bold")
    call <SID>X("Folded", "3c78a2", "c3daea", "")
    call <SID>X("IncSearch", "708090", "f0e68c", "")
    call <SID>X("Pmenu", "ffffff", "cb2f27", "")
    call <SID>X("SignColumn", "", "", "")
    call <SID>X("CursorLine", "000000", "c0d9eb", "NONE")
    call <SID>X("CursorLineNr", "ffffff", "dddddd", "NONE")
    call <SID>X("LineNr", "dddddd", "", "NONE")
    ...
    call <SID>X("pythonClass", "ff0086", "", "")
	 ...
	 " Markdown
    call <SID>X("markdownCode", "", "fafafa", "")
